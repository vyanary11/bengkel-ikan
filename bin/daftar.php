...
if (isset($_POST[daftar])) {
	...
	if (mysqli_num_rows($sqlcek)==1) {
		?>
		    <meta http-equiv="refresh" content="0; url=<?php echo $base_url; ?>/daftar/msg=emailsudahada">  
		<?php 
	}else{
		$pass=md5($_POST[password]);
		$kd_aktivasi=rand();
		$daftar=mysqli_query($conn, "INSERT INTO user VALUES('','$_POST[email]','$pass','$_POST[nama]','','','','','','','','$_POST[telp]','','default.png','user','','$kd_aktivasi',now())");
		if ($daftar) {
