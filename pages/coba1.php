<?php
  ...
  if($_GET[s]==1){
    ...
    $tengah="Hore! Pesanan NO. INVOICE <strong>#".$data_orders[kd_order]."</strong> dengan nama barang <strong>".$data_dtl_order[nama_barang]."</strong> sedang diproses oleh seller. Terima kasih atas kepercayaan kamu berbelanja di bengkelikan.com.";
