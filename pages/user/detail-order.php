  ...
  <table class="table table-bordered" cellspacing="0" style="font-size: 12px">
    <thead class="bg-light">
      <tr>
        ...
        <?php if($data_detail_orders[status]=="p"){ ?>
    ...
    <tbody>
      ...
      <tr>
        ...
        <?php if($data_detail_orders[status]=="p"){ ?>
        <td class="align-middle text-center">
            <a class="btn btn-success" data-toggle="modal"  href="#validmodal<?php echo ++$counter3 ?>" role="button"><span class="fa fa-fa-truck ptooltip" data-toggle="tooltip" data-placement="top" title="Kirim Pesanan"></span></a>
        </td>
        <?php } ?>
            <!-- MODAL KIRIM -->
            <div class="modal fade" id="invalidmodal<?php echo $counter3 ?>" tabindex="-1" role="dialog" aria-labelledby="invalidmodallabel" aria-hidden="true">
