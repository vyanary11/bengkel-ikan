<?php
  ...
  $url_detail_pesanan='<a href="'.$base_url.'/user/detail-pesanan='.$data_order[kd_order].'/'.$data_order[kd_user].'" class="btn btn-primary">Lihat Detail Pesanan</a>';
  ...
  <div class="container">
    <div class="row justify-content-center my-5">
      <div class="col-7" style="margin:0 auto;">
        ...
        <h1 class="text-center text-dark">Rp. '.number_format(str_replace(" ","" ,$tdepan)).',<mark class="bg-light text-dark">'.str_replace(" ","" ,$tbelakang).'</mark></h1>
        <p class="text-center"><b>TEPAT</b> hingga <b>3 digit terakhir</b><br>Perbedaan nilai transfer akan menghambat proses verifikasi
        </p>
        <br>
        <p class="text-justify">Pembayaran dapat dilakukan ke salah satu nomor rekening a/n BengkelIkan.com:</p>
        <div class="row">
          <ul class="list-unstyled col-7" style="margin:0 auto;">
            <li class="media border border-secondary border-left-0 border-right-0 py-3">
              <img class="mr-3 img-fluid" src="'.$base_url.'/assets/images/mandiri.gif" alt="Generic placeholder image">
              <div class="media-body text-right" style="width:100%;">
                <h5 class="mt-0 mb-1">Bank Mandiri, Jember</h5>
                0700 000 765 976
              </div>
            </li>
            <li class="media mt-4 border border-secondary border-left-0 border-right-0 border-top-0 py-3">
              <img class="mr-3 img-fluid" src="'.$base_url.'/assets/images/bni.gif">
              <div class="media-body text-right" style="width:100%;">
                <h5 class="mt-0 mb-1">Bank BNI, Jember</h5>
                0700 000 765 976
              </div>
            </li>
            <li class="media mt-4 border border-secondary border-left-0 border-right-0 border-top-0 py-3">
              <img class="mr-3 img-fluid" src="'.$base_url.'/assets/images/bca.gif">
              <div class="media-body text-right" style="width:100%;">
                <h5 class="mt-0 mb-1">Bank BCA, Jember</h5>
                0700 000 765 976
              </div>
            </li>
            <li class="media mt-4 border border-secondary border-left-0 border-right-0 border-top-0 py-3">
              <img class="mr-3 img-fluid" src="'.$base_url.'/assets/images/bri.gif">
              <div class="media-body text-right" style="width:100%;">
                <h5 class="mt-0 mb-1">Bank BRI, Jember</h5>
                0700 000 765 976
              </div>
            </li>
          </ul>
        ...
        <p>Berikut adalah penjelasan tagihan pembayaran:</p>
          <div class="card border-bottom-0">
            <div class="card-header bg-primary text-white text-center" style="width:100%;">
                <h4 class="card-title">Invoice #'.$data_order[kd_order].'</h4>
            </div>
          </div>
              ...
              <table class="table border-left-0 border-right-0" style="margin-bottom: 0">
                <tbody>
                  <tr>
                    ...
                    <td class="font-weight-bold text-right" colspan="2">Rp.'.number_format($total).'</td>
                  </tr>
                  <tr>
                    <td width="400px;" >Kode Pembayaran <font class="text-muted" style="font-size: 10px;">(Hanya dibebankan kepada pembeli)</font</td>
                    <td class="font-weight-bold text-right" colspan="2">Rp.'.$randomangka.'</td>
                  </tr>
                </tbody>
                <tfoot class="bg-light">
                  <tr>
                    <td width="400px;" class="font-weight-bold">TOTAL PEMBAYARAN</td>
                    <td class="font-weight-bold text-right text-white bg-primary" colspan="2">Rp. '.number_format($totalakhir).'</td>
                  </tr>   
                </tfoot>
              </table>
            </div>
...
$mail->Subject = 'Tagihan dan Petunjuk Pembayaran - Invoice No #'.$data_order[kd_order].' - Bengkel Ikan';
