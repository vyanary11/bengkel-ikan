  ...
  <div class="card-body">
    <div class="table-responsive" style="font-size: 14px">
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
          <?php 
            $sql_orders=mysqli_query($conn, "SELECT * FROM orders left join user on user.kd_user=orders.kd_user order by kd_order desc");
            while($data_orders=mysqli_fetch_assoc($sql_orders)){
          ?>
          <tr>
            <td><?php echo ++$no; ?></td>
            <td class="align-middle">#<?php echo ucwords($data_orders[kd_order]) ?></td>
            ...
            <td class="align-middle text-center">
              <a class="btn btn-info" href="<?php echo $base_url ?>/dashboard/pesanan/detail-pesanan/id=<?php echo $data_orders[kd_order] ?>" role="button"><span class="fa fa-eye ptooltip" data-toggle="tooltip" data-placement="top" title="Detail"></span></a>
            </td>
