	...
	<div class="col-lg-5">
		<div class="card">
			<div class="card-body">
				...
				<form method="post" action="<?php echo $base_url; ?>/dashboard/bin/reset_password.php?kd_user=<?php echo $_GET['kd_user']; ?>&kode_reset_password=<?php echo $_GET['kode_reset_password']; ?>">
